<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto py-10 pb-32">
        ...
        <p class="text-gray-600 text-center mb-10">
            Estos datos nos permiten crear tu perfil de empresa y habilitar tu panel de gestión.
        </p>
        ...
        <div class="sticky top-0 z-50 py-3 mb-6 bg-white">
            <div class="flex items-center justify-center gap-3">
                ...
                {{-- Botón con tick --}}
                <button form="empresa-form" type="submit"
        ...
        <form id="empresa-form" method="POST" action="{{ route('empresa.register.extra.store') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="cif" value="{{ old('cif') }}" class="w-full border-gray-300 rounded-md"
                        required>
